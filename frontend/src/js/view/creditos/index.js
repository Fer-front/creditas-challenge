...
import Credito from '../../services/credito/credito';
import taxas from '../../constants/taxas';
import veiculos from '../../constants/veiculos';
import imovel from '../../constants/imovel';
...
function updateParcela() {
  const parcela = Credito.calcValorParcela(
    form.prazo,
    formResult.totalEmprestimo
  );
  formResult.updateParcela(parcela);
}

function updateTotalEmprestimo() {
  const totalEmprestimo = Credito.calcTotalEmprestimo(
    form.prazo,
    form.valorEmprestimo
  );
